...
DEFAULT_MAX_RAW_FRAMES_PER_STREAM = 200000
DEFAULT_MAX_POINTS_PER_CELL = DEFAULT_MAX_RAW_FRAMES_PER_STREAM
DEFAULT_DASH_HOST = "127.0.0.1"
DEFAULT_DASH_PORT = 8050
DEFAULT_REPLAY_SPEED = 1.0
DEFAULT_REFRESH_INTERVAL_MS = 100
DEFAULT_INGEST_INTERVAL_MS = 25
DEFAULT_GUI_TARGET_FPS = 60
DEFAULT_RENDER_TARGET_FPS = DEFAULT_GUI_TARGET_FPS
DEFAULT_RENDER_INTERVAL_MS = 16
DEFAULT_STATUS_INTERVAL_MS = 500
DEFAULT_DIAGNOSTICS_INTERVAL_MS = 1000
MAX_INPUT_CHUNKS_PER_DASH_TICK = 200
MAX_PARSE_RESULTS_PER_TICK = 5000
DISPLAY_DOWNSAMPLE_TARGET_POINTS = 1200
